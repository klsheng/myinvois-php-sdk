...
class NotificationService extends BaseService
{
     ...
     * 
     * @param DateTime  $dateFrom   Optional: start date and time for notifications to retrieve based on the date sent
     * @param DateTime  $dateTo     Optional: end date and time for notifications to retrieve based on the date sent
